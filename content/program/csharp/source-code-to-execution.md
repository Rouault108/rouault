...
[^14]: Microsoft Learn, *Ildasm.exe (IL Disassembler)*. PEファイル中のIL、メタデータ、アセンブリマニフェストを観察する公式ツールの説明。[https://learn.microsoft.com/en-us/dotnet/framework/tools/ildasm-exe-il-disassembler](https://learn.microsoft.com/en-us/dotnet/framework/tools/ildasm-exe-il-disassembler)。
