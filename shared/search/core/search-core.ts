import { addFailure, finalizeDiagnostics } from '../../../shared/search/diagnostics.js';
import { createDefaultPagefindLoader } from '../../../src/search/sources/pagefind-source.js';
import { getSearchCatalog, type SearchCatalogItem } from '../search-catalog.js';
import type { SearchRequest, SearchResponse } from '../search-types.js';
import {
