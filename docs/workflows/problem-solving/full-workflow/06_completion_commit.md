...
```text
- `../r4-validation/08_r4_schema_and_validation.md` の正規化規則とSchema規則に従っている
...
- R4-S / R4-I / R4-Aでは`../r4-validation/schemas/r4-execution-ledger.schema.json`の必須項目を満たしている。R4-Sでは`../r4-validation/schemas/lightweight-resolution-manifest.schema.json`、R4-I / R4-Aでは`../r4-validation/schemas/artifact-manifest.schema.json`、R4-Aでは`../r4-validation/schemas/closure-manifest.schema.json`の必須項目を満たしている
