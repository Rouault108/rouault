...
- R4-S / R4-I / R4-AのManifest / Ledger / Closureは人手記入だけで完了扱いにせず、`../r4-validation/08_r4_schema_and_validation.md` と `../r4-validation/schemas/` の機械可読契約およびvalidator意味制約に照合する
...
- Manifest / Anchor / Ledger / Closureの正規化規則を `../r4-validation/08_r4_schema_and_validation.md` に分離する
...
| R4 / A2機械可読契約、正規化、Schema、検証CLI契約                                                                                                                                                                                                                                                                                                                                                                                                    | `../r4-validation/08_r4_schema_and_validation.md`、`../r4-validation/schemas/` | R4 Lightweight Resolution Manifest / Artifact Manifest / Ledger / ClosureおよびA2 Evidence Integrity Attestationの構造制約とvalidator意味制約の正本 |
...
| `../r4-validation/08_r4_schema_and_validation.md` | R4 / A2の機械可読契約、正規化、Schema、検証CLI契約   |
| `../r4-validation/schemas/`                       | R4 / A2主要成果物のJSON Schema雛形                   |
| `../r4-validation/tools/`                         | JSON Schema検証とvalidator意味制約を実行する最小実装 |
| `../r4-validation/samples/`                       | validator確認用の正常/異常最小JSONサンプル           |
...
```bash
python -m pip install -r ../r4-validation/tools/requirements.txt
python ../r4-validation/tools/validate-workflow-artifacts.py --sample-manifest ../r4-validation/samples/manifest.json
python ../r4-validation/tools/validate-workflow-artifacts.py --schema ../r4-validation/schemas/r4-execution-ledger.schema.json --file ../r4-validation/samples/valid/r4-s-execution-ledger.lifecycle-passed.json --mode completion
```
...
必要に応じて 07_roles.md
  ↓
R4では ../r4-validation/08_r4_schema_and_validation.md と ../r4-validation/schemas/
```
