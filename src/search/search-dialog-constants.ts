...
export const LOADING_HEADING = '検索インデックスを読み込んでいます';
...
export const ERROR_HEADING = '検索結果を取得できませんでした';
export const ERROR_DESCRIPTION = '時間をおいて再度お試しください';
export const KEYBOARD_HINT = '↑ ↓ で移動 / Enter で選択';
export const BODY_SEARCH_DIALOG_OPEN_ATTRIBUTE = 'data-search-dialog-open';
