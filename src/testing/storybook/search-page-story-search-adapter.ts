...
const MOCK_ITEMS: readonly MockSearchItem[] = [
  {
    ...
    snippet: 'Routerの設計と遷移制御をまとめたメモです。',
    description: 'Routerの設計ノート',
    date: '2026-03-01',
  ...
  },
  {
    ...
    snippet: 'Litの描画最適化と差分更新をまとめています。',
    description: 'Litの描画最適化メモ',
    date: '2026-02-12',
  ...
  },
  {
    ...
    snippet: 'Routerのイベント境界と購読戦略を整理しています。',
    description: 'Routerのイベント境界設計メモ',
    date: '2026-01-11',
