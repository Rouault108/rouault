...
export const Default: Story = {
    render: () => renderFoundationFrame({
        title: 'Heading Scale',
        description: '見出しは本文より密度を高くし、階層差はサイズだけでなく weight と tracking でも作ります。'
    }, html `
        ${renderFoundationSection('Heading Preview', renderTokenSampleGrid([
        {
            label: 'H1',
            note: '主要タイトル。最も強い階層。',
        ...
        ${renderFoundationSection('Token Contract', renderTokenValueList([
