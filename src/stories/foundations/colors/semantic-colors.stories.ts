...
import { renderFoundationFrame, renderFoundationSection, renderTokenSwatchGrid, renderTokenValueList, } from '../../shared/foundation-story-helpers';
...
const meta: Meta = {
    ...
    parameters: {
        docs: {
            description: {
                component: '意味論トークンとして使うブランド色・本文色・状態色を俯瞰するためのストーリーです。'
            }
        }
    }
};
...
export const Default: Story = {
    render: () => renderFoundationFrame({
        ...
        description: 'Rouault の色は飾りではなく意味を持ちます。本文・状態・強調の役割単位で確認します。'
    }, html `
        ${renderFoundationSection('Brand / Foreground', renderTokenSwatchGrid([
        {
            label: 'Primary',
            token: '--primary',
        ...
        ${renderFoundationSection('Status Colors', renderTokenSwatchGrid([
        {
            label: 'Danger',
        ...
        ${renderFoundationSection('Token Reference', renderTokenValueList([
