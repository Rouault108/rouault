...
export const TOC_MOBILE_PANEL_STYLING_SELECTOR = '.layout-toc-mobile-panel';
...
export const TOC_MOBILE_PANEL_DOM_CONTRACT = {
  panelSelector: TOC_MOBILE_PANEL_SELECTOR,
} as const;

export const TOC_MOBILE_PANEL_CSS_CONTRACT = {
  stylingSelector: TOC_MOBILE_PANEL_STYLING_SELECTOR,
