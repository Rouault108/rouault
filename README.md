...
`pnpm build:production`を直接実行する場合は、production buildの由来を明示するため`ROUAULT_BUILD_LABEL`を指定してください。
...
- `docs/contracts/`: router / router-document / navigation / hydration / sidebar / note-navigation / permanent-url / search / markdown / corpus / content-config / testing-taxonomyの機能契約
